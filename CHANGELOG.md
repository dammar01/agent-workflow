...
| Version | Notes | Theme |
|---------|-------|-------|
| 3.5.2 | [prompt/v3.5.2/changelog.md](prompt/v3.5.2/changelog.md) | Token nyata dari provider masuk ke usage.jsonl: reasoning dan cached ikut terekam sebagai rincian yang tak pernah dijumlahkan; satu baris per panggilan provider; codex terukur, opencode tetap estimasi dengan alasan yang dicatat |
