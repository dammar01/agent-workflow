# Second Agent — v3.3.1 Setup Prompt (OpenCode, Read-Only)
...
**Perubahan v3.3.1 (relevan second_agent):**
...
### FILE: ~/.config/opencode/AGENTS.md
    ...
    <!-- WORKFLOW-SECOND-AGENT:START — v3.3.1, do not edit manually -->
    # OpenCode Second Agent — v3.3.1
