# Main Agent — v3.4.0 Setup Prompt (Agent-Agnostic Orchestrator)
...
**Perubahan v3.4.0 (tercermin di kode):**
...
## STEP 7 — Final Report
    ...
    [SETUP COMPLETE — v3.4.0 DUAL AGENT MODE]
    ...
    Config: {CONFIG_FILE} (managed block v3.4.0, ramping) | Session hook: session-bind.ps1 (Claude Code) | .sh (POSIX bila didukung)
