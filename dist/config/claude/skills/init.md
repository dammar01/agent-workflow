...
generated: run/inspect/check.{ps1,sh} + config.json (v3.5.2, main_py_path abs) + second_agent.json (copy) + sessions/ (state/scope/cache/logs/runtime per-session, lazy)
